...
export function AnalyticsPage() {
  ...
  const effectiveBenefits = React.useMemo(() => expandCardBenefitsForCards(cardBenefits.benefits, cardsQuery.cards.filter((card) => card.active)), [cardBenefits.benefits, cardsQuery.cards])
